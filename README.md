...
|**Fig. 7** Gene ontology (GO) and signaling pathway analyses were performed on the signature genes.|![Fig. 7](https://github.com/dunhuiliu/RGIE/blob/main/res/Figure%207.jpg)||
...
|**Table 4.** Classification performance comparison using the selected nine genes.|![Table 4](https://github.com/dunhuiliu/RGIE/blob/main/res/Figure%204.jpg)|Run [5.2_classifier_comparison_9_genes.ipynb](https://github.com/dunhuiliu/RGIE/blob/main/5.2_classifier_comparison_9_genes.ipynb).|
...
|**Fig. 9** qRT‐PCR validation of the expression of 9 signature genes.|![Fig. 9](https://github.com/dunhuiliu/RGIE/blob/main/res/Figure%209.jpg)||
