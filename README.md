...
|**Fig. 7** Gene ontology (GO) and signaling pathway analyses were performed on the signature genes.|![Fig. 7](https://github.com/dunhuiliu/RGIE/blob/main/res/Figure%207.jpg)|The plotting data is stored in [result_data/gopath](). The figure was plotted by https://www.bioinformatics.com.cn , an online platform for data analysis and visualization.|
